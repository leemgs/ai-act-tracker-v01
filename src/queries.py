...
# 키워드: AI copyright, AI governance, AI lawsuit, AI regulation, AI 거버넌스, AI 저작권, AI 규제, AI 기본법, EU AI Act
NEWS_QUERIES = [
    '("AI regulation" OR "AI governance" OR "AI Act" OR "AI policy") when:3d',
    '("AI copyright" OR "AI intellectual property" OR "AI copyright lawsuit") when:3d',
